...
void xi_tridiagonal(double (*rhs)[4], double (*q)[4], double *dt,
  ...
  // for(j=1; j<dim->jtot-1; j++){
    ...
    L[i][0] =       (-lambda_plus               )*dt[i]*grid->V[i];
    D[i][0] = 1.0 + ( lambda_plus - lambda_minus)*dt[i]*grid->V[i];
    U[i][0] =       ( lambda_minus              )*dt[i]*grid->V[i];

    // lambda 1 = lambda 0
    L[i][1] =       (-lambda_plus               )*dt[i]*grid->V[i];
    D[i][1] = 1.0 + ( lambda_plus - lambda_minus)*dt[i]*grid->V[i];
    U[i][1] =       ( lambda_minus              )*dt[i]*grid->V[i];
    ...
    L[i][2] =       (-lambda_plus               )*dt[i]*grid->V[i];
    D[i][2] = 1.0 + ( lambda_plus - lambda_minus)*dt[i]*grid->V[i];
    U[i][2] =       ( lambda_minus              )*dt[i]*grid->V[i];
    ...
    L[i][3] =       (-lambda_plus               )*dt[i]*grid->V[i];
    D[i][3] = 1.0 + ( lambda_plus - lambda_minus)*dt[i]*grid->V[i];
    U[i][3] =       ( lambda_minus              )*dt[i]*grid->V[i];
