...
dvars = np.zeros((4,3))
dvars[0,:] = [ 0.150,  0.500,   0.750] # lower loc
dvars[1,:] = [ 0.250,  0.500,   0.750] # upper loc
dvars[2,:] = [ 0.010,  0.000,   0.000] # lower mag
dvars[3,:] = [ 0.000,  0.000,   0.000] # upper mag

np.savetxt("start.dat", dvars)
