...
void jroeflux(double* q_l, double* q_r, double* rhs_m1, double* rhs, Dim *dim,
  ...
  lambda_tilda_s = max(lambda_tilda, 0.0);
...
void kroeflux(double* q_l, double* q_r, double* rhs_m1, double* rhs, Dim *dim,
	      double xy1[2], double xy2[2], int k){
